...
import {DownOutlined} from "@ant-design/icons"; // ✨ 아이콘 추가

const HeroContainer = styled.section`
  min-height: 100vh;
  position: relative; // ✨ 화살표의 절대 위치 기준
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
  /* ✨ 하단 화살표 공간을 위해 패딩 아래쪽을 넉넉히(120px) 줍니다 */
  ...
  const roleData = [
    {
      ...
      title: "기획 및 UI/UX 설계",
      description:
        "사용자 요구사항을 분석하여 직관적인 UI/UX를 설계하고, 시스템의 전체적인 데이터 흐름과 아키텍처를 기획합니다.",
      techIcons: [
    ...
    },
    {
      ...
      description:
        "Java/Spring 기반의 안정적인 백엔드와 React 중심의 고도화된 프론트엔드를 연결하여 풀스택 솔루션을 구축합니다.",
    ...
    <HeroContainer>
      ...
      >
        ...
        >
          ...
          아키텍처로 해결합니다.
          <br />
          데이터의 흐름을 설계하고 운영의 효율성을 극대화하는 풀스택 3년차 자바
          웹 개발자 이나현입니다.
        </Paragraph>
      </Flex>
