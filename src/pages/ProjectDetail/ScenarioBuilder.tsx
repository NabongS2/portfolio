...
// ✨ InfoBox & GlassCard 공통 스타일 (밝기 UP)
const glassStyle = `
  background: rgba(30, 41, 59, 0.7); /* ✨ 투명도를 낮춰서(0.4 -> 0.7) 배경을 더 밝게 */
  backdrop-filter: blur(20px);
  border: 1px solid rgba(255, 255, 255, 0.15); /* ✨ 테두리를 더 밝고 선명하게 */
  box-shadow: 0 8px 32px rgba(0, 0, 0, 0.2); /* 깊이감 추가 */
`;
...
// ✨ 텍스트 색상 유틸리티: 기존보다 더 밝은 회색 사용
const lightGray = "#CBD5E1"; // 기존 #94A3B8 보다 밝음
const mediumGray = "#94A3B8"; // 기존 #64748B 보다 밝음
  ...
  return (
    <DetailContainer>
            ...
            <Space direction="vertical" size={32} style={{width: "100%"}}>
              <div>
                ...
                >
                  ...
                  직접 관리할 수 있는 웹 기반 빌더입니다. 복잡한 JSON 대화 모델
                  구조를 시각화하여 설계하고, 실시간 발화 테스트 기능을
                  제공함으로써 운영 효율을 극대화하는 것을 목표로 했습니다.
                </Paragraph>
              </div>
              ...
              <Row gutter={[16, 16]}>
                <Col span={12}>
                  ...
                  <div style={{color: "#F8FAFC", marginTop: "8px"}}>
                    2024.05 ~ 2024.09 <br />
      ...
      <ContentSection
        ...
        viewport={{once: true}}
      >
        <Title level={3} style={{color: "#F8FAFC", marginBottom: "40px"}}>
          📁 담당 업무 및 해결 과정
        </Title>
        ...
        <Space direction="vertical" size={40} style={{width: "100%"}}>
          {/* 1-1. 시나리오 빌더 */}
          <div>
            <Title level={4} style={{color: "#60A5FA"}}>
              1-1) 시나리오 빌더(Scenario Builder) 개발
            </Title>
            <Paragraph style={{color: "#94A3B8"}}>
              콜봇 대화 모델 JSON을 React Flow 기반의 시각적인 플로우 UI로
              구성하여 운영 편의성을 획기적으로 개선했습니다.
            </Paragraph>
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <HighlightCard>
          ...
          >
            <Title level={4} style={{color: "#C1FF33"}}>
              <ThunderboltFilled /> 성능 개선 및 버전 관리 도입
            </Title>
            <Row gutter={[32, 32]}>
              <Col xs={24} md={12}>
                <Text
                ...
                <Paragraph style={{color: "#94A3B8", marginTop: "12px"}}>
                  대용량 JSON 조회 시 MariaDB의 속도 저하 문제를 해결하기 위해{" "}
                  <strong>Redis 기반 하이브리드 구조</strong>를 설계했습니다.
                </Paragraph>
                <div
                  style={{
                    color: "#10B981",
              ...
              <Col xs={24} md={12}>
                ...
                <Paragraph style={{color: "#94A3B8", marginTop: "12px"}}>
                  실수 방지 및 실험 환경 분리를 위해 Redis와 MariaDB를 연동한{" "}
                  <strong>Rollback 체계</strong>를 구축했습니다.
                </Paragraph>
                <Tag color="cyan">버전 비교</Tag>
                <Tag color="cyan">이력 적재</Tag>
                <Tag color="cyan">롤백 기능</Tag>
              </Col>
            </Row>
          </div>
          ...
          <div>
            <Title level={4} style={{color: "#60A5FA"}}>
              2) NLU 사전 관리 및 발화 테스트
            </Title>
            <Row gutter={[24, 24]}>
              <Col xs={24} lg={16}>
                <Paragraph style={{color: "#94A3B8", lineHeight: 1.8}}>
                  NLU 코어 엔진과 연동하여 의도(Intent)와 치환(Synonym)을
                  관리하는 백오피스를 구축했습니다. 사용자가 입력한 문장을
                  실시간으로 엔진에 전달하고 분석 결과를 시각화하여{" "}
                  <strong>사전의 품질을 즉각적으로 확인</strong>할 수 있습니다.
                </Paragraph>
              </Col>
              <Col xs={24} lg={8}>
                <div
                ...
                >
                  <Text style={{color: "#F8FAFC", fontSize: "0.9rem"}}>
                    주요 기능
                  </Text>
                  <ul
                    style={{
      ...
      <ContentSection>
        <GlassCard style={{textAlign: "center", border: "1px solid #3B82F6"}}>
          <Title level={3} style={{color: "#3B82F6", marginBottom: "32px"}}>
            ✅ 프로젝트 핵심 성과
          </Title>
          <Row gutter={[24, 24]}>
            {[
